...
//     // NEW: Education field (from CounselorProfile)
//     education: {
//         type: String,
//         default: ""
//     },
    
//     // NEW: Certifications array (from CounselorProfile)
//     certifications: [{
//         name: {
//             type: String,
//             required: true
...
//     // NEW: Rating and Stats (calculated fields)
//     rating: {
//         type: Number,
//         default: 0,
//         min: 0,
...
//         if (this.role === "counsellor" && !this.uniqueCode) {
         
//             const timestamp = Date.now().toString().slice(-6);
//             const random = Math.random().toString(36).substring(2, 8).toUpperCase();
//             this.uniqueCode = `CNS-${timestamp}${random}`;
//         }
//         next();
//     } catch (error) {
//         next(error);
